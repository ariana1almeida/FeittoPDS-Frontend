        ...
        <div className="w-full max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="terms" className="text-sm text-primary-dark cursor-pointer leading-tight">
                        Eu li e aceito os{" "}
                        <a href="#/terms" className="text-accent-yellow font-medium hover:underline">
                            termos de uso
                        </a>{" "}
                        e{" "}
                        <a href="#/terms" className="text-accent-yellow font-medium hover:underline">
