    ...
    return (
        <div className="flex flex-col items-center mb-8 relative">
            ...
            <label
                ...
                className="bg-accent-green rounded-full p-2 cursor-pointer shadow-lg hover:bg-accent-yellow-hover transition-colors absolute right-14 top-18"
            >
                <CameraIcon className="h-5 w-5 text-primary-dark"/>
